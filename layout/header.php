        ...
        <div id="container">
            <div id="header-wp">
                <div id="head-top" class="clearfix">
                    <div class="wp-inner">
                        <a href="?modules=payments&action=payment" title="" id="payment-link" class="fl-left">Hình thức thanh toán</a>
                        <div id="main-menu-wp" class="fl-right">
                            <ul id="main-menu" class="clearfix">
                                ...
                                <li>
                                    ...
                                    echo 
                                    '<div class="dropdown">
                                    <a href="#" title="" class="dropbtn">Xin chào, '
                                    .$_SESSION['fullname']
                                    .' </a>                                    
                                    <div class="dropdown-content">
                                    <a href="?modules=users&action=info"><h5>Thông tin tài khoản</h5></a>
                                    <a href="?modules=users&action=passwordChange"><h5>Đổi mật khẩu</h5></a>
                                    <a href="?modules=checkouts&controllers=index&action=story"><h5>Lịch sử đơn hàng</h5></a>
                                    <a href="?modules=users&action=logout" title=""><h5>Đăng xuất</h5></a>
                                    </div>
                                    </div>'
                                    ;

                                    else echo '<a href="?modules=users&action=index" title="">
                                    Đăng nhập</a>'; 
                                    ?>                                        
                                </li>                                
                ...
                <div id="head-body" class="clearfix">
                    <div class="wp-inner">
                        <a href="?modules=home" title="" id="logo" class="fl-left">
                            <img src="public/images/VMN_STORE_PHONE.png"/>
                        </a>
